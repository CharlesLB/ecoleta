...
const CreatePoint = () => {
    ...
    function handleSelectUd(event: ChangeEvent<HTMLSelectElement>){
        const ufInitials = event.target.value;

        setSelectedUf(ufInitials);
    }
    ...
    function handleSelectItem (id: number){
        const alreadySelected: number = selectedItems.findIndex(item => item === id);
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value={selectedUf} onChange={handleSelectUd}>
